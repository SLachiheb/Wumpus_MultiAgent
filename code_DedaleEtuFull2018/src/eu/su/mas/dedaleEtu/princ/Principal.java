...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		Object [] entityParameter={"My parameters"};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift.class.getName(), entityParameter);
		agentList.add(ag);*/
		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
		agentName="Golem";
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersE1= new Object []{EntityType.AgentExplorateur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentExplorateur.class.getName(), entityParametersE1);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersE2= new Object []{EntityType.AgentExplorateur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentExplorateur.class.getName(), entityParametersE2);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC1=new Object []{EntityType.AgentCollecteur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollecteur.class.getName(), entityParametersC1);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC2=new Object []{EntityType.AgentCollecteur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollecteur.class.getName(), entityParametersC2);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC3=new Object []{EntityType.AgentCollecteur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollecteur.class.getName(), entityParametersC3);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersT = new Object []{EntityType.AgentTanker};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentTanker.class.getName(), entityParametersT);
		agentList.add(ag);
