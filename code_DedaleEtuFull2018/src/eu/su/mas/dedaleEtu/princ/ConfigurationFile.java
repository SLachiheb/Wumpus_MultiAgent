...
public final class ConfigurationFile {
	 ...
	 */
	public static String INSTANCE_TOPOLOGY= "mapExamen2019/map2019-topologyExam1";
	//public static String INSTANCE_TOPOLOGY="resources/map2018-topology";
	//public static String INSTANCE_TOPOLOGY=null;
	//public static String INSTANCE_TOPOLOGY="mapExamples/mapInterlocking1-topology";
	//public static String INSTANCE_TOPOLOGY="mapExamples/mapInterlocking2-topology";
	//public static String INSTANCE_TOPOLOGY="mapExamples/mapCarre1_topology";


	/**
	 * Not null when the environment is loaded; should be null if the environment is generated or already online
	 */
	public static String INSTANCE_CONFIGURATION_ELEMENTS="mapExamen2019/map2019-elementsExam1";
	...
	//public static String INSTANCE_CONFIGURATION_ELEMENTS="mapExamples/mapInterlocking1-elements";
	//public static String INSTANCE_CONFIGURATION_ELEMENTS="mapExamples/mapInterlocking2-elements";
	//public static String INSTANCE_CONFIGURATION_ELEMENTS="mapExamples/mapCarre1_elements";

	/**
	 * Must'nt be null as it describes the agents capabilities on the map
	 */
	public static String INSTANCE_CONFIGURATION_ENTITIES="mapExamen2019/map2019-entitiesExam1";
	...
	//public static String INSTANCE_CONFIGURATION_ENTITIES="mapExamples/mapInterlocking1-entities";
	//public static String INSTANCE_CONFIGURATION_ENTITIES="mapExamples/mapInterlocking2-entities";
	//public static String INSTANCE_CONFIGURATION_ENTITIES="mapExamples/mapCarre1_entities";
