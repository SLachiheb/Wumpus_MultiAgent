...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersA1= new Object []{EntityType.AgentExplorateur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentExplorateur.class.getName(), entityParametersA1);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParameters=new Object []{EntityType.AgentCollecteur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollecteur.class.getName(), entityParameters);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParameters2=new Object []{EntityType.AgentCollecteur};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentCollecteur.class.getName(), entityParameters2);
		agentList.add(ag);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersT2 = new Object []{EntityType.AgentTanker};
		
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentTanker.class.getName(), entityParametersT2);
		agentList.add(ag);
		/*********************
		 * All agents created
		 *********************/
